        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'Financial System') }}
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('teste') }}">Transactions</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('teste') }}">Receivable</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('teste') }}">Payable</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="dropdown-item" href="{{url('currency')}}">Currency</a>
